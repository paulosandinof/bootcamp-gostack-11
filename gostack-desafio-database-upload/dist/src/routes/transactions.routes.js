    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, deleteTransaction.execute({ transaction_id: id })];
            case 1:
                _a.sent();
...
transactionsRouter.post('/import', upload.single('file'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var file, csv, importTransactionsService, transactions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                file = request.file;
                csv = file.buffer.toString();
                importTransactionsService = new ImportTransactionsService_1.default();
                return [4 /*yield*/, importTransactionsService.execute({ csv: csv })];
            case 1:
                transactions = _a.sent();
