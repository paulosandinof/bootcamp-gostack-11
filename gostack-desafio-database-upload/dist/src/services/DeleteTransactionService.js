...
var DeleteTransactionService = /** @class */ (function () {
    ...
    DeleteTransactionService.prototype.execute = function (_a) {
        var transaction_id = _a.transaction_id;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        transaction = _b.sent();
                        if (!transaction) {
                            throw new AppError_1.default("This transaction doesn't exists", 400);
                        }
                        return [4 /*yield*/, transactionRepository.delete(transaction.id)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
