...
var TransactionsRepository = /** @class */ (function (_super) {
    ...
    TransactionsRepository.prototype.getBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var transactions, balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.find()];
                    case 1:
                        transactions = _a.sent();
                        balance = transactions.reduce(function (previous, _a) {
                            var _b;
                            var type = _a.type, value = _a.value;
                            return __assign(__assign({}, previous), (_b = {}, _b[type] = previous[type] + value, _b));
                        }, {
                            income: 0,
                            outcome: 0,
                        });
                        return [2 /*return*/, __assign(__assign({}, balance), { total: balance.income - balance.outcome })];
                }
            });
        });
    };
