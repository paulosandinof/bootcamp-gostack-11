...
var _FakeStorageProvider = _interopRequireDefault(require("../../../shared/providers/StorageProvider/fakes/FakeStorageProvider"));
...
describe('UpdateUserAvatar', () => {
  ...
  it('should delete old avatar when updating user', async () => {
