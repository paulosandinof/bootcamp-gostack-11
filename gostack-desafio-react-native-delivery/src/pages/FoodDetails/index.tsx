...
const FoodDetails: React.FC = () => {
  ...
  useEffect(() => {
    async function loadFood(): Promise<void> {
      const { data: foodsData } = await api.get(`/foods/${routeParams.id}`);
      ...
      const extrasWithQuantity = foodsData.extras.map((extra: Extra) => {
      ...
      const checkFavorite = favoritesData.find((favorite: { id: number }) => {
        return favorite.id === foodsData.id;
      });
